...
_ttdBodies = 30*60; // seconds to delete dead bodies (0 means don't delete)
_ttdVehiclesDead = 30*60; // seconds to delete dead vehicles (0 means don't delete)
_ttdVehiclesImmobile = 0*60; // seconds to delete immobile vehicles (0 means don't delete)

GVAR(deleteClassesConfig) = [
	[30*60, ["WeaponHolder","GroundWeaponHolder","WeaponHolderSimulated"]],
	[60*60, ["TimeBombCore"]],
	[30*60, ["SmokeShell"]],
	[30*60, ["CraterLong_small","CraterLong"]],
	[30*60, ["AGM_SpareWheel","AGM_JerryCan","AGM_SpareTrack","AGM_FastRoping_Helper"]],
	[30*60, ["#dynamicsound","#destructioneffects","#track","#particlesource"]]
];
