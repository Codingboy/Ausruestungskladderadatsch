...
CODI_LO_fnc_rflm_rus_emr = {
   ...
   CODI_LO_weaponPacks = [["mp443","pmm"],["grenades_he_bp","grenades_flash_bp","grenades_smoke_bp"],["ak12","akm","ak74mmtk","ak74m"],[]];//darf nur bereits definierte waffen enthalten, siehe ingamenamen beim ausrüstungsdialog
};
